...
type Designer = { profile: string; title: string; name: string; description: string };
const services: Designer[] = [
  {
    profile: profile1,
    title: 'profile1',
    name: '이현아 대표원장',
